...
import (
	...
	"github.com/xpanel/ai/internal/handler"
)
...
func main() {
	...
	goose.SetTableName("ai_goose_migrations")
	...
	app.Get("/health", func(c *fiber.Ctx) error {
		return c.JSON(fiber.Map{"status": "ok", "service": "ai", "version": version})
	})
